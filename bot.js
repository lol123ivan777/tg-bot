...
const mainMenuKb = {
  inline_keyboard: [
    [{ text: '🎩 Одинарные трюки (UNO / DOS / TRI / ЖЕСТЬ)', callback_data: 'uno_menu' }],
    [{ text: '🌀 Комбо блок', callback_data: 'combo_menu' }],
    [{ text: '🎲 Поле чудес (рандом трюк)', callback_data: 'any' }],
...
Выбери комбу и готовься умирать.
...
<b>UNO</b> — одинарные трюки.  
<b>DOS</b> — двойные.  
<b>TRI</b> — тройные.  
<b>ЖЕСТЬ</b> — самые сложные, для уверенных.

<b>Комбо через темп</b> — элемент, пауза, следующий, типа: сальто — темп — двойное — двойное.  
<b>Комбо в темп</b> — всё подряд, без пауз: элемент элемент, сальто два три три.  
<b>Комбо вомбо</b> — самые жёсткие связки.

<b>Поле чудес</b> — просто рандомный трюк из всех списков.`,
        mainMenuKb,
      );
  }
});